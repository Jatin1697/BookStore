      ...
      <div class="container">
      	<div class="table_row">
			...
			<table class="col-md-3 col-sm-3">
			      	...
			      	<tr><td><a href="#">100% Purchase protection</a></td></tr>
			      	<tr><td><a href="#">Returns centre</a></td></tr>
			</table>
			<table class="col-md-3 col-sm-3">
			...
			<table class="col-md-3 col-sm-3">
			      	...
			      	<tr><td><a href="#">Privacy</a></td></tr>	
			      	<tr><td><a href="#">Terms of use</a></td></tr>
			      	<tr><td><a href="#">Security</a></td></tr>
			</table>
      	</div>
      </div>
    </footer>
